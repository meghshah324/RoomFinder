...
const MyListings = () => {
  ...
  const handleDeleteConfirm = async () => {
    ...
    try {
      ...
      setListings(
        listings.filter((listing) => listing._id !== listingToDelete._id)
      );
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
              <div>
                ...
                <p className="text-green-100 text-sm sm:text-base mt-1">
                  Manage your property listings in one place
                </p>
              </div>
              <Link
                to="/form/profile"
            ...
            {listings.length === 0 ? (
              <div className="text-center py-12 sm:py-16 px-4">
                ...
                <p className="text-gray-500 text-sm sm:text-base max-w-md mx-auto mb-6 sm:mb-8">
                  You haven't posted any rooms yet. Create your first listing to
                  start showcasing your property.
                </p>
                <Link
                  to="/form/profile"
                    ...
                    <div className="relative h-48 sm:h-56 md:h-64 w-full overflow-hidden">
                      ...
                      <div className="absolute top-3 right-3 sm:top-4 sm:right-4 bg-white bg-opacity-90 rounded-full py-1 px-2 sm:px-3 shadow-md">
                        <div className="flex items-center">
                          <IndianRupee
                            size={12}
                            className="sm:size-[14px] text-green-600 mr-1"
                          />
                    ...
                    >
                      <div className="mb-3 sm:mb-4">
                        ...
                        <div className="flex items-center text-gray-600 mt-1 sm:mt-2">
                          <MapPinned
                            size={14}
                            className="sm:size-[16px] mr-1 sm:mr-2 flex-shrink-0 text-green-600"
                          />
                      ...
                      <div className="flex items-center justify-between mb-4 sm:mb-6 bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                        <div className="flex flex-col items-center">
                          <div className="bg-green-100 rounded-full p-1.5 sm:p-2 mb-1 sm:mb-2">
                            <Building
                              size={14}
                              className="sm:size-[16px] text-green-600"
                            />
                          </div>
                        ...
                        <div className="flex flex-col items-center">
                          <div className="bg-blue-100 rounded-full p-1.5 sm:p-2 mb-1 sm:mb-2">
                            <Users
                              size={14}
                              className="sm:size-[16px] text-blue-600"
                            />
                          </div>
                          <span className="text-xs text-gray-500 mb-0.5 sm:mb-1">
                            For
                        ...
                        <div className="flex flex-col items-center">
                          <div className="bg-purple-100 rounded-full p-1.5 sm:p-2 mb-1 sm:mb-2">
                            <Briefcase
                              size={14}
                              className="sm:size-[16px] text-purple-600"
                            />
                          </div>
                          <span className="text-xs text-gray-500 mb-0.5 sm:mb-1">
                            Occupation
                      ...
                      <div className="grid grid-cols-2 gap-2 sm:gap-3">
                        <button
                          ...
                          className="bg-blue-50 hover:bg-blue-100 text-blue-600 py-2 px-1 sm:py-2.5 sm:px-2 rounded-lg transition-all duration-200 flex items-center justify-center gap-1.5 text-xs sm:text-sm font-medium border border-blue-100 hover:border-blue-200"
                        >
                          <MessageCircle
                            size={14}
                            className="sm:size-[16px] flex-shrink-0"
                          />
                        ...
                        <button
                          ...
                          className="bg-red-50 hover:bg-red-100 text-red-600 py-2 px-1 sm:py-2.5 sm:px-2 rounded-lg transition-all duration-200 flex items-center justify-center gap-1.5 text-xs sm:text-sm font-medium border border-red-100 hover:border-red-200"
                        >
                          <Trash2
                            size={14}
                            className="sm:size-[16px] flex-shrink-0"
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">
                        {listingToDelete.roomType} in{" "}
                        {listingToDelete.buildingType}
                      </h4>
